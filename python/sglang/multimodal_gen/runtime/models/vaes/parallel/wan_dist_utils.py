...
def halo_exchange(
    ...
    if rank > 0:
        ...
        ops.append(dist.P2POp(dist.irecv, recv_top_buf, prev_rank, group=group))
        ops.append(dist.P2POp(dist.isend, top_row, prev_rank, group=group))
    if rank < world_size - 1:
        ...
        ops.append(dist.P2POp(dist.isend, bottom_row, next_rank, group=group))
        ops.append(dist.P2POp(dist.irecv, recv_bottom_buf, next_rank, group=group))
